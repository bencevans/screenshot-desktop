...
function isWayland() {
  return process.env.XDG_SESSION_TYPE?.toLowerCase().includes('wayland');
}
function isGNOME() {
  return process.env.XDG_CURRENT_DESKTOP?.toLowerCase().includes('gnome');
}
function isUNITY() {
  return process.env.XDG_CURRENT_DESKTOP?.toLowerCase().includes('unity');
}
